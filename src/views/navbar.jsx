        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
              ...
              <MenuItem onClick={handleCloseNavMenu}>
                <Typography textAlign="center">Verify Certificate</Typography>
              </MenuItem>
              <MenuItem onClick={handleCloseNavMenu}>
                <Typography textAlign="center">Find Certificate</Typography>
              </MenuItem>
            </Menu>
          </Box>
          {/* <CheckIcon sx={{ color: "#08ad6c" }}>check</CheckIcon> */}
          <CheckIcon sx={{ display: { xs: 'flex', md: 'none' }, mr: 1 }} />
          <Typography
            variant="h5"
            noWrap
            component="a"
